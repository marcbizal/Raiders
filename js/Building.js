define(['Map'], function(Map) {
	...
	function Building()
	{
		...
		loader.load('models/teleport-pad.dae', function (model) {
			...
			that.model.position.set(that.x, that.y, that.z);
		...
		loader.load('models/riser.dae', function (model) {
			...
			that.riser.position.set(that.x, that.y, that.z);
	...
	Building.prototype.setX = function(x) {
		this.x = x;
		if (this.model) this.model.position.setX(x);
	};
	Building.prototype.setY = function(y) {
		this.y = y;
		if (this.model) this.model.position.setY(y);
	};
	Building.prototype.setZ = function(z) {
		this.z = z;
		if (this.model) this.model.position.setZ(z);
	}
